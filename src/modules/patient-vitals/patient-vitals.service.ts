...
export class PatientVitalsService {
  ...
  async create(dto: CreatePatientVitalsDto, staffId?: string) {
    ...
    if (invoiceId) {
      ...
      return this.createForInvoice(invoiceId, patientId, vitalsPayload, staffId);
  ...
  private async createForEncounter(
    ...
    return this.prisma.patientVitals.create({
      ...
      data: {
        ...
        ...(staffId ? { createdBy: { connect: { id: staffId } } } : {}),
    ...
    if (invoice.vitals) {
      ...
      return this.prisma.patientVitals.update({
        ...
        data: {
          ...
          ...(staffId && !invoice.vitals.createdById
    ...
    if (waiting.vitals) {
      ...
      return this.prisma.patientVitals.update({
        ...
        data: {
          ...
          ...(staffId && !waiting.vitals.createdById
