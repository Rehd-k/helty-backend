...
export class CreateTransactionDto {
  ...
  @ApiPropertyOptional({
    description: 'Admission UUID — if this is an inpatient bill',
  })
  @IsOptional()
  admissionId?: string;

  @ApiPropertyOptional({
    description: 'NoIdPatient UUID — if patient has no ID',
  })
  @IsOptional()
...
export class QueryTransactionDto {
  @ApiPropertyOptional({
    description:
      'Free-text search across transactionID, patient name and patient phone',
    example: 'John',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Exact or partial match on the human-readable Transaction ID (e.g. BILL-2025-00012)',
    example: 'BILL-2025',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Patient UUID — filter all transactions for this patient',
  })
  @IsOptional()
  patientId?: string;
...
export class AddTransactionItemDto {
  ...
  @ApiPropertyOptional({
    description: 'Optional reference ID (e.g. lab report ID, prescription ID)',
  })
  @IsString()
  @IsOptional()
  referenceId?: string;
...
export class RecordPaymentDto {
  ...
  @ApiProperty({
    description: 'Staff UUID of the cashier receiving this payment',
  })
  @IsNotEmpty()
  staffId: string;

  @ApiPropertyOptional({
    description: 'Reference number (POS receipt, bank transfer ref, etc.)',
  })
  @IsString()
  @IsOptional()
  reference?: string;
...
export class ApplyDiscountDto {
  ...
  @ApiProperty({
    description:
      'Value: percentage (e.g. 10 for 10%) or fixed naira amount (e.g. 5000)',
    example: 10,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Staff UUID of the person granting the discount',
  })
  @IsNotEmpty()
  staffId: string;
}
...
export class ApplyInsuranceDto {
  ...
  @ApiProperty({
    description: 'Staff UUID of the person applying the insurance claim',
  })
  @IsNotEmpty()
  staffId: string;
...
export class CreateRefundDto {
  ...
  @ApiProperty({
    description: 'Staff UUID of the person processing the refund',
  })
  @IsNotEmpty()
  staffId: string;
}
...
export class QuickTransactionItemDto {
  ...
  @ApiPropertyOptional({
    description: 'Reference ID (e.g. lab report UUID, prescription UUID)',
  })
  @IsString()
  @IsOptional()
  referenceId?: string;
...
export class QuickTransactionDiscountDto {
  ...
  @ApiProperty({
    description: 'Percentage (e.g. 10 for 10%) or fixed naira amount',
    example: 10,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    description: 'Reason for discount / waiver',
    example: 'Staff benefit',
  })
  @IsString()
  @IsNotEmpty()
  reason: string;
...
export class QuickTransactionPaymentDto {
  ...
  @ApiPropertyOptional({
    description: 'Reference (POS receipt, bank transfer ref, etc.)',
  })
  @IsString()
  @IsOptional()
  reference?: string;
...
export class CreateQuickTransactionDto {
  ...
  @ApiProperty({
    description:
      'Staff UUID of the person creating and receiving this transaction (cashier / frontdesk)',
  })
  @IsNotEmpty()
  staffId: string;
  ...
  @ApiPropertyOptional({
    description: 'NoIdPatient UUID — for patients without a formal ID',
  })
  @IsOptional()
  noIdPatientId?: string;
  ...
  @ApiProperty({
    ...
    description:
      'One or more charge items to add to the transaction. At least one is required.',
  })
