...
export class TransactionController {
  ...
  @ApiOperation({
    summary:
      'Create a fully-calculated one-shot transaction (items + discount + insurance + payment)',
    description:
  ...
  @ApiNotFoundResponse({
    description: 'Patient, Staff, or Admission not found.',
  })
  @ApiBadRequestResponse({
    description:
  ...
  @ApiBadRequestResponse({
    description: 'Admission does not belong to the given patient.',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      'Free-text search (transactionID, patient name/phone, staff name)',
  })
  @ApiQuery({
    name: 'transactionID',
    required: false,
    description: 'Partial match on Transaction ID (e.g. BILL-2025)',
  })
  @ApiQuery({
    name: 'patientId',
    required: false,
  ...
  @ApiQuery({
    name: 'patientName',
    required: false,
    description: 'Search by patient first or last name',
  })
  @ApiQuery({
    name: 'phoneNumber',
    required: false,
  ...
  @ApiQuery({
    name: 'createdById',
    required: false,
    description: 'Filter by the Staff UUID who created the transaction',
  })
  @ApiQuery({
    name: 'status',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    description:
      'End date (ISO 8601, e.g. 2025-12-31) — inclusive of entire day',
  })
  @ApiQuery({
    name: 'skip',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Records to return (default: 20)',
  })
  @ApiQuery({
    name: 'sortBy',
    required: false,
  ...
  @ApiOkResponse({
    description: 'Returns { data, total, skip, take, pageCount }.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns all transactions for a patient (by UUID) plus aggregated count.',
  })
  ...
  @ApiParam({
    name: 'id',
    description:
      'Transaction UUID or human-readable transactionID (BILL-YYYY-NNNNN)',
  })
  @ApiOkResponse({
    description: 'Full transaction detail with outstandingBalance.',
  })
  ...
  @ApiUnprocessableEntityResponse({
    description:
      'Invalid status transition (e.g. PAID → DRAFT is not allowed).',
  })
  updateTransaction(
    @Param('id') id: string,
  ...
  @ApiNotFoundResponse({ description: 'Transaction or Staff not found.' })
  @ApiBadRequestResponse({
    description: 'Transaction is cancelled, or invalid price/quantity.',
  })
  ...
  @ApiOkResponse({
    description: 'Item updated and transaction total recalculated.',
  })
  @ApiNotFoundResponse({
    description: 'Transaction, Item, or Staff not found.',
  })
  @ApiBadRequestResponse({
    description: 'Transaction is cancelled, or invalid price/quantity.',
  })
  ...
  @ApiCreatedResponse({
    description:
      'Payment recorded. Returns payment + newOutstanding + newStatus.',
  })
  @ApiNotFoundResponse({ description: 'Transaction or Staff not found.' })
  @ApiBadRequestResponse({
    description:
  ...
  @ApiBadRequestResponse({
    description:
      'Transaction cancelled, no items, percentage > 100%, or discounts exceed total.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Updates the status, covered amount, or notes of an existing insurance claim.',
  })
  @ApiParam({ name: 'id', description: 'Transaction UUID or transactionID' })
  @ApiParam({ name: 'claimId', description: 'InsuranceClaim UUID' })
  @ApiOkResponse({ description: 'Claim updated.' })
  @ApiNotFoundResponse({
    description: 'Transaction, Claim, or Staff not found.',
  })
  @ApiBadRequestResponse({
    description: 'Updated coverage would exceed remaining balance.',
  })
  ...
  @ApiParam({ name: 'id', description: 'Transaction UUID or transactionID' })
  @ApiCreatedResponse({
    description: 'Refund issued. Returns refund + newStatus + newAmountPaid.',
  })
  @ApiNotFoundResponse({ description: 'Transaction or Staff not found.' })
  @ApiBadRequestResponse({
    description: 'Refund amount exceeds total amount paid.',
  })
  ...
  @ApiBadRequestResponse({
    description:
      'Transaction is already cancelled, or payments have been made.',
  })
  cancelTransaction(
    @Param('id') id: string,
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Records to return (default: 50)',
  })
